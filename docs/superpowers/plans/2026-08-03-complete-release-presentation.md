...
**Files:** Create `src/core/SaveEnvelope.js`, `src/ui/panels/save-recovery-panel.js`, `test/node/save-v9-envelope.test.mjs`, `test/browser-save-recovery.spec.js`; modify `src/core/SaveManager.js`, `src/main.js`, `src/ui/PopupManager.js`, `test/node/save-v7-migration.test.mjs`, `test/node/save-v8-migration.test.mjs`.
...
- [ ] **Step 5: Commit** `git add src/core/SaveEnvelope.js src/ui/panels/save-recovery-panel.js test/node/save-v9-envelope.test.mjs test/browser-save-recovery.spec.js src/core/SaveManager.js src/main.js src/ui/PopupManager.js test/node/save-v7-migration.test.mjs test/node/save-v8-migration.test.mjs; git commit -m "feat: add v9 save recovery"`
