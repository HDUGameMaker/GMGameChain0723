...
export function renderLuxuryTradePanel(data, body, pm) {
  ...
  body.innerHTML = `<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px"><div><b style="font-size:18px;color:#e7ca83">奢侈品与贸易</b><div style="font-size:11px;color:#999">首份提供帝国效果，重复份可贸易</div></div>${outpost ? `<span style="font-size:12px;color:#9fb6dc">贸易对象：${outpost.name}</span>` : ''}</div>`;
